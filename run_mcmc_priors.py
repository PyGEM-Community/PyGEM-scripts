...
def getparser():
    ...
    # add arguments
    parser.add_argument('-rgi_regionsO1_single', action='store', type=int, default=None,
                        help='RGI order 1 region')
    return parser
...
if args.rgi_regionsO1_single is None:
